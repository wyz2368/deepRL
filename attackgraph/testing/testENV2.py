...
def env_rand_gen(env_name, num_attr_N = 11, num_attr_E = 4, T=10, graphid=1, numNodes=30, numEdges=100, numRoot=5, numGoals=6, history = 3):
...
env = env_rand_gen('run_env_14isAND')
print(env.get_Roots())
