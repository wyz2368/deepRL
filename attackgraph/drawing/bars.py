...
performance = [mean1,mean2,mean3]
error = [[mean1-min1,mean2-min2,mean3-min3],[max1-mean1,max2-mean2,max3-mean3]]
...
ax.barh(y_pos, performance, xerr=error, color=('orange','purple','green') , align='center', ecolor='black')
ax.set_yticks(y_pos)
